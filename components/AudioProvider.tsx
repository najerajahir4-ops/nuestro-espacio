...
function MuteButton() {
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.9 }}
      className="fixed bottom-6 left-6 z-50 p-4 bg-card/80 backdrop-blur-md border border-muted/50 rounded-full shadow-lg text-foreground opacity-70 transition-colors hover:bg-card hover:border-accent hover:text-accent group"
